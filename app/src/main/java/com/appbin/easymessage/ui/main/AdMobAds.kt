...
class AdMobAds(private val context : Context, private val linearLayout : LinearLayout) {

    fun refreshAd(adId:String) {
        ...
        builder.forUnifiedNativeAd { unifiedNativeAd ->
            ...
            val adView = LayoutInflater.from(context)
                .inflate(R.layout.unified_native_ad_view, null) as UnifiedNativeAdView
